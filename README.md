# Isacc Ricardo Peña Simancas — portafolio

Desarrollador de automatización e integraciones en Santiago de Chile (100% remoto): n8n, Python, bots de Telegram/WhatsApp,
agentes con LLM, scraping con APIs públicas y despliegue en servidores Linux con Docker. Autodidacta: aprendo construyendo
y cada proyecto de esta lista está corriendo o corrió con usuarios reales. Entrego una versión chica funcionando primero,
muestro evidencia (no promesas) y documento cómo se mantiene. Español nativo; inglés básico.

| Proyecto | Qué es | Estado | Código |
|---|---|---|---|
| [PymeTrazza](proyectos/pymetrazza.md) | SaaS multi-tenant de logística de última milla para pymes LATAM | En desarrollo / lanzamiento en Chile | privado |
